...
app.config['MAIL_USERNAME'] = 'greenhouse.iot.test@gmail.com'
app.config['MAIL_PASSWORD'] = 'ogwbbbzhdgbfaojb'
app.config['MAIL_DEFAULT_SENDER'] = 'greenhouse.iot.test@gmail.com'
